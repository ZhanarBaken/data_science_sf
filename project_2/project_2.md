...
**ВЫВОДЫ**  
*Скорее всего кандидат в 100 лет не может быть трудоспособен, это аномалия*   
...
**ВЫВОДЫ**   
*Как уже ранее писала, здесь наглядно видно, что 100 лет это аномалия, так же в глаза бросаются 77 лет и 76 лет, где всего по 1 кандидату, скорее всего это тоже аномалии, но начиная с 73 лет уже намного реальней сатистика.*   
*Так же, начиная с 40 лет до 20 лет больше всего кандидатов, можно сделать вывод что, в этом возрасте люди чаще всего имеют*   *желание сменить работу или даже род деятельности после того как, например, поработали после окончания ВУЗа по специальности.*    
*В более старшем возрасте работники уже либо идут на повышение, либо получают офферы, т.е. у них нет необходимости пользоваться*  *такими ресурсами как HH.*   
...
**ВЫВОДЫ**   
*Общее количество кандидатов состовляет 44,743 (без «ошибочного» возраста 100),*   
*выше 40 лет состовляет около 14%, это доказывает, что работу ищут обычно между 20 и 40 лет*  
