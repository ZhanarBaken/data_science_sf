...
**ВЫВОДЫ**   
*Здесь наглядно видно, что 100 лет это аномалия, так же в глаза бросаются 77 лет и 76 лет, где всего по 1 кандидату,*  
*скорее всего это тоже "ошибочные" возраста,  но начиная с 73 лет сатистика намного реальней.*   
*Так же, между с 40 лет до 20 лет приходится больше всего кандидатов, можно сделать вывод что, в этом возрасте люди*   
*чаще всего имеют желание сменить работу или даже род деятельности после того как, например, поработали*   
*после окончания ВУЗа по специальности. В более старшем возрасте работники уже либо идут на повышение, либо получают*   
*офферы, т.е. у них нет необходимости пользоваться такими ресурсами как HH.*   
...
**ВЫВОДЫ**   
*Общее количество кандидатов состовляет 44,743 (без «ошибочного» возраста 100), по этой выборке кандидаы до 40 лет*   
*составляют всего 14%, это доказывает, что работу  меняют обычно до 40 лет*  
...
**ВЫВОДЫ**    
*В Москае больше всего проектную работу ищут мужчины нежели женщины.*   
*Так же видим, что большая часть соискателей-мужчин, ищут работу в сфере IT, а женщины в сфере аналитики и организации*   
*Возраст чаще всего приходится на 35-40 лет.*  
...
*это говорит о том что, люди ищущие работу в этой сфере, график обычно не играет большую роль.*   
*Хоть в выборку вошло малое количество резюме, в глаза бросаются кандидаты старше 50 лет.*  
...
**ВЫВОДЫ**   
*Скорее всего в этом возрасте люди, уже имеют постоянную работу, или не умеют пользоваться такими сервисами как НН,*   
*либо уже не имеют здоровья, чтобы работать.*   
...
**ВЫВОДЫ**   
*Всего 161 соискателей в диапозоне 16-21 лет из города Санкт-Петергбург.*  
*Среди молодежи популярны профессии из сферы IT.*   
